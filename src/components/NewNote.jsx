...
const NewNote = () => {
  ...
  return (
    <>
      ...
      <NoteForm
        className={`${openNewNoteForm ? 'scale-y-100 scale-x-100' : 'scale-y-0 scale-x-0'} bg-gray-800 shadow-2xl rounded-lg transition-all origin-bottom fixed bottom-28 left-0 right-0 w-fit mx-auto p-4 grid`}
